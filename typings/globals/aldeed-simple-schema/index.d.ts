...
interface SimpleSchema_Static {
	new (
		definition: SimpleSchemaDefinition | SimpleSchema_Instance[],
	): SimpleSchema_Instance;
	extendOptions(options: { [option: string]: any }): void;
	addValidator(validator: Function): void;
	messages(
		messageKeysAndTexts:
			| { [errorKey: string]: string /** Text for that error **/ }
...
interface SimpleSchema_Instance {
	messages(messages: Record<string, any>): void;
